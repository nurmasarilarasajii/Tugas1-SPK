...
<div class="art-nav-outer">
	<ul class="art-hmenu">
		...
		<li>
			<a href="tentang.php" class="active"><span class="l"></span><span class="r"></span><span class="t">Tentang</span></a>
		</li>	
		<li>
...
<div class="art-post-inner art-article">
                ...
                <img src="images/postheadericon.png" width="28" height="27" alt="" />Tentang Program
                </h2>
                                <div class="art-postcontent">

<p>Sistem pakar diagnosa penyakit Mata ini merupakan sebuah sistem yang dapat membantu memberikan informasi dalam mendiagnosa penyakit mata.
sistem ini menggunakan basis pengetahuan yang didapatkan dari beberapa pakar kesehatan mata yaitu para dokter spesialis mata.</p>
<p>Sistem pakar ini menggunakan metode Fuzzy Mamdani yang dapat memberikan output berupa penyakit apa saja yang diderita berdasarkan gejala yang diinput.</p>

<p>Terimakasih buat Dosen pembimbing yang telah memberikan banyak bimbingan dan arahan dalam perancangan program ini.</p>
