...
<p><marquee scrolldelay="20"><strong>Sistem Pakar Diagnosa Penyakit Mata</strong></marquee></p>
<p><img width="250" src="images/human-eye-2.jpg" alt="an image" style="float:left;" />Sistem pakar diagnosa penyakit pada mata ini merupakan sebuah sistem yang dapat membantu para penderita penyakit mata dalam mendiagnosa penyakit mata. sistem ini menggunakan basis pengetahuan yang didapatkan dari beberapa pakar kesehatan mata dapat mendeteksi gejala-gejala dini penyakit pada mata sehingga akan membantu anda dalam memberikan solusi pengotan yang tepat.</p>
<br />
<a style="background-color:#F90; color:#ffffff;padding:5px 120px 13px 120px; border:2px dashed #333;" href="proses-diagnosa.php?top=pasien_add_fm.php" class="active"><span class="l"></span><span class="r"></span><span class="t"><strong>Mulai Diagnosa &raquo;&raquo;</strong></span></a><br /><br />
<p>Penyakit mata sangat beragam dan tidak semuanya dapat menular. Jika penyakit mata disebabkan virus atau bakteri maka bisa menular, sedangkan jika penyebabnya alergi tidak akan menular. Cara penanganan dan pencegahan macam-macam penyakit mata ini pun berbeda, tergantung penyebabnya. Berikut ini beragam penyakit mata yang perlu anda ketahui.<img src="images/2137_tear_film_label_v3_250.jpg" alt="an image" width="235" height="257" style="float:right;" /></p>
<p></p>
</div>
...
<p>Sistem Pakar Diagnosa Penyakit Mata</p>
